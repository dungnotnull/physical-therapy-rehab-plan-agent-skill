---
name: physical-therapy-rehab-plan-sub-profile-intake
description: Capture injury type, stage, diagnosis (if any), pain, function goals, and medical context.
---

## Role
Sub-skill of `physical-therapy-rehab-plan` (Physical Therapy / Rehab Plan Support). Acts as the **pre-gate screener**.

## Purpose
Capture injury type, stage, diagnosis (if any), pain, function goals, and medical context.
